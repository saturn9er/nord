...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-xl-8 col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="get" action="{{ url('cashier/tickets/search') }}">
                        ...
                        <div class="form-row" style="margin-bottom: 20px;">
                            ...
                            <div class="col-6" id="datepicker-container">
                                <select name="passengers" id="passengers-count" class="form-control" hidden>
                                    @for ($i = 1; $i < 10; $i++)
                ...
                <div class="card-body">
                    ...
                    <div class="form-row" style="margin-bottom: 5px;">
                        <div class="col-12 text-right">
                            <a href="{{ url('cashier/tickets/sell').'?trip='.$ticket->trip_id.'&passengers='.$request->passengers }}" class="btn btn-outline-danger font-weight-bold" role="button" aria-pressed="true">Продать за {{ intval($ticket->price)*intval($request->passengers) }}₽*</a>
                        </div>
                    </div>
                    <div class="form-row" style="margin-bottom: -10px;">
                        <div class="col-12 text-right">
