...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-xl-8 col-12">
            <h2 class="font-weight-bold">@lang('report.report') "@lang('report.trips')"</h2>
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="font-weight-bold">@lang('report.completed_trips')</h4>
...
<script>
    jQuery(document).ready(function($){
        ...
        $('#datepicker-input').change(function(){
            ...
            window.location.href = '{{ url('agent/reports/trips').'/' }}'+date;
        });
    });
</script>
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['@lang("report.completed_trips")', '@lang("report.trips")', { role: 'style'}],
            ['@lang("report.arrived_earlier")', {{ $tripsArrivedEarlier }}, 'green'],
            ['@lang("report.arrived_in_time")', {{ $tripsArrivedInTime }}, 'blue'],
            ['@lang("report.arrived_later")', {{ $tripsArrivedLater }}, 'orange'],
            ['@lang("report.cancelled")', {{ $tripsCancelled }}, 'red'],
        ]);

        // Set chart options
        var options = {'title':'@lang('report.completed_trips')',
            'width':450,
            'height':300};
